...
def _ebics_config_upgrade(env, version):
    ...
    for cfg_data in cfg_datas:
        ...
        for fld in [
                ...
                'ebics_ini_letter', 'ebics_ini_letter_fn',
                'ebics_public_bank_keys', 'ebics_public_bank_keys_fn',
